...
tuple_fruits = ("melon", "apple", "banana", "cherry")                           # 다음 값을 변화 시킬수 없다.
list_fruits_constructor = list(("melon", "apple", "banana", "cherry"))          # 다음 값을 변화 시킬수 있다.
...
list_fruits_primitive.remove('apple')                   # 리스트 안에 내용 삭제시키는 방법
